...
static const struct key_entry ideapad_keymap[] = {
	{ KE_KEY, 0x02, { KEY_DISPLAY_OFF } }, /* not on Yoga */
	{ KE_KEY, 0x03, { KEY_PROG1 } }, /* not on Yoga */
	{ KE_KEY, 0x04, { KEY_BRIGHTNESS_CYCLE } }, /* not on Yoga */
	{ KE_KEY, 0x05, { KEY_F13 } },/* not on Yoga */
        { KE_KEY, 6,  { KEY_SWITCHVIDEOMODE } },
        { KE_KEY, 7,  { KEY_CAMERA } },/* not on Yoga */
	{ KE_KEY, 0x0B, { KEY_VIDEO_NEXT } }, /* not on Yoga */
        { KE_KEY, 11, { KEY_F16 } },/* not on Yoga */
        { KE_KEY, 13, { KEY_WLAN } },
        { KE_KEY, 16, { KEY_PROG1 } }, /* used for Novo key ? */
        { KE_KEY, 17, { KEY_PROG2 } }, /* used for Novo key ? */
        { KE_KEY, 64, { KEY_PROG3 } }, /* not on Yoga */
        { KE_KEY, 65, { KEY_PROG4 } }, /* not on Yoga */
        { KE_KEY, 66, { KEY_TOUCHPAD_OFF } }, /* not on Yoga */
        { KE_KEY, 67, { KEY_TOUCHPAD_ON } }, /* not on Yoga */
        { KE_END, 0 },
};
...
static int ideapad_input_init(struct ideapad_private *priv)
{
        ...
        inputdev->name = "Yoga extra buttons";
...
static void ideapad_input_novokey(struct ideapad_private *priv)
{
	...
	/* long_pressed doesn't seem to work */
...
static void ideapad_acpi_notify(struct acpi_device *adevice, u32 event)
{
        ...
        pr_err("Yoga ACPI notify event: %x %lx\n", event, vpc1);
        ...
        for (vpc_bit = 0; vpc_bit < 16; vpc_bit++) {
                if (test_bit(vpc_bit, &vpc1)) {
                        ...
                        case 0:
                                ...
                                break;
                        default:
                                pr_err("Unknown IdeaPad ACPI notify event: %lu\n", vpc_bit);
                        }
                }
        }
}
